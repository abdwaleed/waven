...
For ephys cache creation, `spikes` is the firing-rate (Hz) array consumed by
the RF/OSI/model workflow and the PSTH-weighted STA shown during individual
Coarse RF inspection.
