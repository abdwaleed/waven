...
in System Configuration to batch convolution work across them. A markedly slower or smaller GPU 
...
Use the physical sampling controls below in **Stimulus & Metadata**, not the percentage slider
whenever possible:
...
The following GUI actions work around the caches the program creates. Feel free to skip or read the following table to become familiar:
