...
ANALYSIS_FIELD_LABELS: Dict[str, str] = {
    ...
    "Dir": "Raw Data Folder",
    "Path Directory": "Coarse RF Cache Library Folder",
    ...
    "Photodiode Port": "Photodiode Digital Input Port",
    ...
    "Excluded Trial Numbers": "Excluded Trial Numbers (1-indexed)",
    "Movie Path": "Stimulus Movie Folder",
    "Library Path": "Gabor Library Folder",
    "Coarse Library Path": "Coarse Gabor Folder",
    "Fine Library Path": "Fine Gabor Folder",
    "Spks Path": "Neural Cache Folder",
    "Full Model Wavelet Path": "Full-Model Cache Library Folder",
...
INPUT_HINTS: Dict[str, str] = {
    ...
    "Photodiode Port": "Trodes digital-input number carrying the photodiode/TTL signal, e.g. 3",
    "Excluded Trial Numbers": "One-indexed list of identified trials to omit when creating a cache, e.g. [2, 5]",
    ...
    "Block End": "Initial Suite2p frames to discard before alignment, e.g. 0",
